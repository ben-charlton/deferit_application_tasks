...
ax1.plot(thirtyDayMavg.loc[start_date:end_date, :].index, thirtyDayMavg.loc[start_date:end_date, 'Adj Close'], label = '30 day MAVG')
ax1.plot(tenDayMavg.loc[start_date:end_date, :].index, tenDayMavg.loc[start_date:end_date, 'Adj Close'], label = '10 day MAVG')
ax1.legend(loc='best')
ax1.set_ylabel('Adj Close')
fig1.savefig('MAVG1.png')
